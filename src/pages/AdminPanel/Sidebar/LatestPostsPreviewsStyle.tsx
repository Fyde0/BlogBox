...
import { postPreviewSmStyle, postPreviewSmStyles } from "../../../components/PostPreview/interfaces/postPreview";
...
export function Component() {
    ...
    function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        newBlogSettings.sidebarLayout.postPreviewStyle = formData.get("postPreviewStyle") as postPreviewSmStyle
                            ...
                            <div className="py-3">
                                <Form.Check id={style} className="d-flex align-items-center">
                                    <Form.Check.Input
                                        ...
                                        value={style}
                                        className="me-3"
                                        defaultChecked={blogSettings.data?.sidebarLayout.postPreviewStyle === style as string}
                                    />
                                    <Form.Check.Label>
